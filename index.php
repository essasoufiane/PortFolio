...
<body>
    <!-- ---------------section pricincpal------------------ -->
    <main>
        <div style="background: #bfcaff;
background: -moz-linear-gradient(top, #bfcaff 0%, #ffffff 100%);
background: -webkit-linear-gradient(top, #bfcaff 0%, #ffffff 100%);
background: linear-gradient(to bottom, #bfcaff 0%, #ffffff 100%);
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#bfcaff', endColorstr='#ffffff',GradientType=0 );
                                ">
            <section class="banniere d-flex flex-column">
                <h1 class="pt-5 pb-2 text-center clr-principale">
                    <span class="hvr-grow-rotate">
                        Développeur Web et Web mobile
                    </span>
                </h1>
                <h2 class="p-5 text-center clr-principale">
                    <span class="hvr-grow-rotate">
                        Soufiane Essaouari
                    </span>
                </h2>
                <div class="d-flex justify-content-center pb-3">
                    ...
                    <button type="button" class=" btn btn-outline-info"><a class=" clr-principale" href="https://github.com/essasoufiane">Mon profil GitHub</a></button>
                </div>
            </section>
            ...
            <section class="pb-5">
                <div class="wrapper">
                    <marquee behavior="alternate"><span class="font-weight-bolder text-danger hvr-pulse">Un devis pour votre projet ? Contactez moi !</span></marquee>
                </div>
        ...
        <section>
            <h2 class=" text-center list-group-item list-group-item list-group-item-action"><span>Compétences</span></h2>
      ...
      <a href="#" target="_blank">Soufiane</a> -->
        <!-- ------------------------articles 1 ------------------ -->
            ...
            <article data-aos-duration="3000" data-aos="fade-up" class="py-4">
                <div class="card shadow" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">J'ai coder ce site avec une approche conceptuelle orienté objet et une architecture MVC totalement fromscratch (à la main). Cliquez <a href="https://github.com/essasoufiane/siteWeb_PourVTC_en_POO_MVC">ici</a> pour voir le code sur GitHub.</p>
                        <a href="https://github.com/essasoufiane/siteWeb_PourVTC_en_POO_MVC" class="btn btn-primary hvr-grow">Voir le site</a>
                    </div>
                </div>
            ...
            <article data-aos-duration="3000" data-aos="fade-up" class="py-4">
                <div class="card shadow" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">J'ai créé un système de login from scratch vous pouvez vous enregistrer et vous connecter et vous serais enregister dans la base de données de ce site vous serais afficher dans la page <a href="utilisateurs.php">utilisateurs</a> .</p>
