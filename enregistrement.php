...
<body>
    <div class="container">
        <h1 class="p-4 my-5 bg-info text-white text-center">Enregistrement</h1>

        <p class="alert text-info text-center alert-info">Enregistrez vous, avec des informations gérérique pour faire le teste !</p>
